...
int main()
{
    ...
    else if(s[0]=='0'&&(int)s[1]>=(int)'5'&&(int)s[1]<=(int)'9')
    cout<<"10:01";
    else if(s=="10:00")
    cout<<"10:01";
    else if(s[0]=='1'&&(int)s[1]<(int)'5')
    {
        s[1]=(char)((int)(s[1]+1));
        s[3]=s[1];
        s[4]=s[0];
    ...
    else if(s[0]=='1'&&(int)s[1]>=(int)'5'&&(int)s[1]<=(int)'9')
    cout<<"20:02";
    else if(s=="20:00"||s=="20:01")
    cout<<"20:02";
    else if(s=="10:00")
    cout<<"10:01";
    else if(s[0]=='2'&&(int)s[1]<(int)'3')
    {
        s[1]=(char)((int)(s[1]+1));
        s[3]=s[1];
        s[4]=s[0];
    ...
    else if(s[0]=='2'&&s[1]=='3'&&(int)s[3]<=(int)'3'&&s[4]<(int)'2')
    cout<<"23:32";
    else if(s[0]=='2'&&s[1]=='3'&&(int)s[3]>=(int)'3'&&s[4]>(int)'2')
    cout<<"00:00";
    else

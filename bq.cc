...
// Given an array of integers and a sum, the task is to print
...
void rec(vector<vector<int>> &v, vector<int> &v1, vector<int> &v2, int k, int i)
{
    if (k == 0)
    {
        for (auto &i : v2)
